...
function App() {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      const responseData = await contract.methods.getData().call();// retrieves data from blockchain
      const hash = responseData.startsWith('https://ipfs.io/ipfs/') ? responseData.substring(24) : responseData;//If the response starts with 'https://ipfs.io/ipfs/', it extracts the IPFS hash from the URL
  ...
  useEffect(() => {
    // save urlFile to blockchain smart contract
    const savedata = async () => {
      await contract.methods.saveData(urlFile).send({//it calls saveData method od the smart contract and passes the urlFile and use send to send it to the blockchain
        from: account//determine the account that is sending this data
      })
    ...
    <div className="App">
      <header className="App-header">
        {/* <header className="App-header2">
          <img src={VMLogo} className="logoo" alt="logo" />
        </header> */}
        ...
        <h4>Recording Instructions: Read the script Carefully!</h4>          
        <div className="script">
          "This script contains all the letters and vowels to preserve<br/> the person's accent and ensure the accurate
            representation<br/> of letter sounds and pronunciation. We understand the importance<br/> of maintaining the authenticity
            of accents and linguistic nuances. With <br/>this comprehensive script, we aim to capture the true essence of<br/> each
            individual's unique way of speaking.”
            <br></br>
          </div>
          <div className="hh">Press the three dots to download your record after recording</div>
          <br></br>
          ...
          <div  >
            <input  className="upload9" type="file" id="formFile" onChange={onChange} />
        ...
        <header className="script-record">
          ...
          <div className="square-container">
            ...
            <div className="displayHash">
              ...
              {showCloudData && <p className="hashsh"><br /><br /><br /> {cloudData}</p>}
        ...
        {/* <div >
          <img src={VMLogo} className="app88" alt="logo" />
        </div> */}
