...
<header className="allR">
<div class="rounded-rectangle">
<div class="section">
    <span class="text0">3K<br />AI voice edits</span>
  </div>
  <div class="section">
    <span class="text0">     5.2K<br />voice scamming</span>
  </div>
  <div class="section">
    <span class="text0">     257<br />secure voice <br /> records </span>
  </div>
  <div class="section">
    <span class="text0">    92%<br />Voice vulnerablility </span>
  </div>
  </div>
</header>
        ...
        <button className="button2" on onClick={() => navigate('/WhyVirtualMe')} >why virtual me </button>
